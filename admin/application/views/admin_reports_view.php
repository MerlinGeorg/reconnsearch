  ...
  <div class="row">
    <div class="col-md-4">
      <div class="media">
        <div class="media-body">
          <div class="display-6">reports page</div>
    ...
    <div class="col-md-8">
      <div class="pull-xs-right" role="toolbar">
                 ...
                 <button class="btn btn-success" data-toggle="modal" data-target="#trackermodal"  onclick="clearall();">Add reports</button> 
      </div>
    </div>
...
<script type="text/javascript">
      ...
      function getreports(){
           $.ajax({
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_reports/displayreports');?>/",
    ...
    function editreports(id){
        $('#modalcaption').text("Edit reports");
        $.ajax({
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_reports/editreports');?>/",
                ...
                success: function(data){
                  ...
                  $('#pageid').val(res.reports_id);   //sets value for the field having id="reportsid"
                   $("#picid").prop('required',false);

                  $('#image1').val(res.reports_pic); 
              $('#imagefill').html('<img  style="width:250px;height:200px;"src="<?php echo base_url();?>/uploads/'+res.reports_pic+'">') 

                  $('#descid').val(res.reports_desc);
                  //$('#designationid').val(res.reports_designation);
                  $('#titleid').val(res.reports_title);
                  $('#dateid').val(res.reports_date);
      ...
      $("#prodForm").submit(function(e) {
        ...
        var form = $(this);
         $.ajax({
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_reports/updatereports');?>/",
              ...
              // serializes the form's elements.
               ...
               if($.trim(data) == "success"){
                  ...
                  getreports();  //if data is updated,then prints 'Data Saved' & hides the editing popup section when the data is updated,then displays the reports table.
               }else{
                  notifyresult('Error','danger');      
                  $('#trackermodal').modal('hide');   
                  getreports();  //if data is not updated,then prints 'Error' & hides the editing popup section when the data is updated,then again displays the reports table.
               }
      ...
      function statuschange(id,status)
        {
          $.ajax({
            method: "POST",
            url: "<?php echo base_url('index.php/Admin_reports/changestatus');?>/",
...
function deletereports(id,img)
{
  var result = confirm("Do you want to delete?");
          if (result) {
              $.ajax({
              method: "POST",
              url: "<?php echo base_url('index.php/Admin_reports/deletereports');?>/",
