  ...
  <div class="row">
    <div class="col-md-4">
      <div class="media">
        <div class="media-body">
          <div class="display-6">Forums page</div>
    ...
    <div class="col-md-8">
      <div class="pull-xs-right" role="toolbar">
                 ...
                 <button class="btn btn-success" data-toggle="modal" data-target="#trackermodal"  onclick="clearall();">Add Forums</button> 
      </div>
    </div>
...
<script type="text/javascript">
      ...
      function getforums(){
           $.ajax({
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_forums/displayforums');?>/",
    ...
    function editforums(id){
        $('#modalcaption').text("Edit forums");
        $.ajax({
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_forums/editforums');?>/",
                ...
                success: function(data){
                  ...
                  $('#pageid').val(res.forums_id);   //sets value for the field having id="forumsid"
                   $("#picid").prop('required',false);

                  $('#image1').val(res.forums_pic); 
              $('#imagefill').html('<img  style="width:250px;height:200px;"src="<?php echo base_url();?>/uploads/'+res.forums_pic+'">') 

                  $('#descid').val(res.forums_desc);
                  //$('#designationid').val(res.forums_designation);
                  $('#titleid').val(res.forums_title);
                  $('#dateid').val(res.forums_date);
      ...
      $("#prodForm").submit(function(e) {
        ...
        var form = $(this);
         $.ajax({
                method: "POST",
                url: "<?php echo base_url('index.php/Admin_forums/updateforums');?>/",
              ...
              // serializes the form's elements.
               ...
               if($.trim(data) == "success"){
                  ...
                  getforums();  //if data is updated,then prints 'Data Saved' & hides the editing popup section when the data is updated,then displays the forums table.
               }else{
                  notifyresult('Error','danger');      
                  $('#trackermodal').modal('hide');   
                  getforums();  //if data is not updated,then prints 'Error' & hides the editing popup section when the data is updated,then again displays the forums table.
               }
      ...
      function statuschange(id,status)
        {
          $.ajax({
            method: "POST",
            url: "<?php echo base_url('index.php/Admin_forums/changestatus');?>/",
...
function deleteforums(id,img)
{
  var result = confirm("Do you want to delete?");
          if (result) {
              $.ajax({
              method: "POST",
              url: "<?php echo base_url('index.php/Admin_forums/deleteforums');?>/",
