...
<html lang="en-us">
  <head>
    ...
    <title>Reconnsearch Admin</title>
    ...
    <div class="mainmenu-block">
      ...
      <nav class="menu-block">
        <ul class="nav">
          <li class="nav-item mainmenu-user-profile">
              ...
              <div class="menu-block-label">
                ...
                <b>RECONNsearch.com</b><br><?php echo $usertype; ?>
              </div>  
        ...
        <ul class="nav">
          ...
          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_whatwedo"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">About-What We Do</div></a></li>


          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_about"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">About Us</div></a></li>

          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_forums"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Forums</div></a></li>

          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_workshops"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Workshops</div></a></li>

          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_articles"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Articles</div></a></li>              
          </li>

        <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_reports"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Reports</div></a></li>              
          </li>
          

          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_mediacoveragetitle"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">MediaCoverage Titles</div></a></li>

          <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_mediacoverageimg"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">MediaCovarage Images</div></a></li>              
          </li>

        <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>index.php/Admin_contact"><i class="icon ion-monitor"></i>
              <div class="menu-block-label">Contact</div></a></li>              
          </li>
      ...
      <div class="view-wrapper">
        ...
        <div class="topbar-wrapper">
          ...
          <div class="topbar-wrapper-mobile-nav"><a class="topbar-togger js-minibar-toggler" href="#"><i class="icon ion-ios-arrow-back hidden-md-down"></i><i class="icon ion-navicon-round hidden-lg-up"></i></a><a class="topbar-togger pull-xs-right hidden-lg-up js-nav-toggler" href="#"><i class="icon ion-android-person"></i></a>
            ...
            --><a class="topbar-wrapper-logo demo-logo" href="Admin_login/welcome">RECONNSEARCH</a>
          </div>
          <!-- END NAV FOR MOBILE-->
